...
| 方法 | 路径 | 后端入口 | Service | 认证要求 | 状态 | 代码依据 |
|---|---|---|---|---|---|---|
| POST | `/api/v1/collector/runs` | `api/collector.py:42` | CollectorService + AwxService | JWT | 已实现（主入口，port_calibration 支持候选去重与 related_server） | `backend/app/api/collector.py`, `backend/app/services/collector_service.py` |
...
| GET | `/api/v1/collector/assets/{target_scope}/{asset_id}/endpoints` | `api/collector.py` | CollectorService | JWT | 已实现（Phase 3.1） | `backend/app/api/collector.py` |
| GET | `/api/v1/collector/port-profiles` | `api/collector.py` | PortProfileService | JWT | 已实现（Phase 3.1） | `backend/app/api/collector.py`, `backend/app/services/port_profile_service.py` |
| GET | `/api/v1/collector/proposals` | `api/collector.py` | AssetProposalService | JWT | 已实现（Phase 3.1） | `backend/app/api/collector.py`, `backend/app/services/asset_proposal_service.py` |
| POST | `/api/v1/collector/proposals/{proposal_id}/approve` | `api/collector.py` | AssetProposalService | JWT | 已实现（Phase 3.1） | `backend/app/api/collector.py`, `backend/app/services/asset_proposal_service.py` |
| POST | `/api/v1/collector/proposals/{proposal_id}/reject` | `api/collector.py` | AssetProposalService | JWT | 已实现（Phase 3.1） | `backend/app/api/collector.py`, `backend/app/services/asset_proposal_service.py` |
| POST | `/api/v1/collector/proposals/{proposal_id}/apply` | `api/collector.py` | AssetProposalService | JWT | 已实现（Phase 3.1） | `backend/app/api/collector.py`, `backend/app/services/asset_proposal_service.py` |
...
### 2.14 AWX 批量校验（Phase 3.2, prefix: `/api/v1/collector`）

| 方法 | 路径 | 后端入口 | Service | 认证要求 | 状态 | 代码依据 |
|---|---|---|---|---|---|---|
| POST | `/api/v1/collector/batch-runs` | `api/collector.py` | BatchCollectorService | JWT | 已实现（Phase 3.2） | `backend/app/api/collector.py`, `backend/app/services/batch_collector_service.py` |
| GET | `/api/v1/collector/batch-runs` | `api/collector.py` | BatchCollectorService | JWT | 已实现（Phase 3.2） | `backend/app/api/collector.py` |
| GET | `/api/v1/collector/batch-runs/{batch_run_id}` | `api/collector.py` | BatchCollectorService | JWT | 已实现（Phase 3.2） | `backend/app/api/collector.py` |
| GET | `/api/v1/collector/batch-runs/{batch_run_id}/dispatches` | `api/collector.py` | BatchCollectorService | JWT | 已实现（Phase 3.2） | `backend/app/api/collector.py` |
...
| assetsApi.createCollectorRun | POST | `/api/v1/collector/runs` | InstanceDetail.vue | 已实现（主入口，支持 `run_type=port_calibration` 与 `options.include_related_server`） | `frontend/src/api/assets.ts` |
...
| assetsApi.listAssetCollectorEndpoints | GET | `/api/v1/collector/assets/{targetScope}/{assetId}/endpoints` | InstanceDetail.vue | 已实现（Phase 3.1） | `frontend/src/api/assets.ts` |
| assetsApi.listPortProfiles | GET | `/api/v1/collector/port-profiles` | InstanceDetail.vue（可扩展） | 已实现（Phase 3.1） | `frontend/src/api/assets.ts` |
| assetsApi.listCollectorProposals | GET | `/api/v1/collector/proposals` | InstanceDetail.vue | 已实现（Phase 3.1） | `frontend/src/api/assets.ts` |
| assetsApi.approveCollectorProposal | POST | `/api/v1/collector/proposals/{id}/approve` | InstanceDetail.vue | 已实现（Phase 3.1） | `frontend/src/api/assets.ts` |
| assetsApi.rejectCollectorProposal | POST | `/api/v1/collector/proposals/{id}/reject` | InstanceDetail.vue | 已实现（Phase 3.1） | `frontend/src/api/assets.ts` |
| assetsApi.applyCollectorProposal | POST | `/api/v1/collector/proposals/{id}/apply` | InstanceDetail.vue | 已实现（Phase 3.1） | `frontend/src/api/assets.ts` |
| assetsApi.createBatchRun | POST | `/api/v1/collector/batch-runs` | BatchVerify.vue | 已实现（Phase 3.2） | `frontend/src/api/assets.ts` |
| assetsApi.listBatchRuns | GET | `/api/v1/collector/batch-runs` | BatchVerify.vue | 已实现（Phase 3.2） | `frontend/src/api/assets.ts` |
| assetsApi.getBatchRun | GET | `/api/v1/collector/batch-runs/{id}` | BatchVerify.vue | 已实现（Phase 3.2） | `frontend/src/api/assets.ts` |
| assetsApi.listBatchDispatches | GET | `/api/v1/collector/batch-runs/{id}/dispatches` | BatchVerify.vue | 已实现（Phase 3.2） | `frontend/src/api/assets.ts` |
| assetsApi.listBatchItems | GET | `/api/v1/collector/batch-runs/{id}/items` | BatchVerify.vue | 已实现（Phase 3.2） | `frontend/src/api/assets.ts` |
| assetsApi.retryFailedBatchItems | POST | `/api/v1/collector/batch-runs/{id}/retry-failed` | BatchVerify.vue | 已实现（Phase 3.2） | `frontend/src/api/assets.ts` |
