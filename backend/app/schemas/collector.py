...
# ============================================================================
# Phase 3.3A — Credential Management Schemas
# ============================================================================
...
class CredentialProfileCreate(BaseModel):
    ...
    credential_type: Literal["ssh_key", "ssh_password", "db_password", "winrm_password", "api_token"]
    awx_credential_id: int = Field(ge=1)
    ...
    default_database: Optional[str] = Field(default=None, max_length=100)
...
class CredentialProfileUpdate(BaseModel):
    ...
    credential_type: Optional[Literal["ssh_key", "ssh_password", "db_password", "winrm_password", "api_token"]] = None
    awx_credential_id: Optional[int] = Field(default=None, ge=1)
    awx_credential_name: Optional[str] = Field(default=None, max_length=200)
    db_type_code: Optional[str] = Field(default=None, max_length=50)
    os_family: Optional[str] = Field(default=None, max_length=50)
    default_database: Optional[str] = Field(default=None, max_length=100)
...
class CredentialBindingCreate(BaseModel):
    ...
    binding_role: str = Field(min_length=1, max_length=50)
    binding_target_type: Literal["server", "db_instance", "cluster", "business_system", "network_zone", "global"]
...
class CredentialBindingUpdate(BaseModel):
    ...
    binding_role: Optional[str] = Field(default=None, min_length=1, max_length=50)
    binding_target_type: Optional[Literal["server", "db_instance", "cluster", "business_system", "network_zone", "global"]] = None
    binding_target_id: Optional[int] = None
    network_zone: Optional[str] = Field(default=None, max_length=100)
...
class AssetFactsLatestResponse(BaseModel):
    """Latest fact snapshot + values for an asset."""
    target_type: str
    target_id: int
    latest_snapshot: Optional[AssetFactSnapshotResponse] = None


class AssetFactsHistoryResponse(BaseModel):
    """List of fact snapshots for an asset."""
    target_type: str
    target_id: int
    total: int = 0
    snapshots: list[AssetFactSnapshotResponse] = Field(default_factory=list)
...
class AssetDriftsResponse(BaseModel):
    """List of drift records for an asset or all assets."""
    total: int = 0
    drifts: list[AssetDriftRecordResponse] = Field(default_factory=list)
